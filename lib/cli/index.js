...
import selfPJson from "../../package.json" with { type: "json" };
const _version = selfPJson.version;

const isWin = _platform() === "win32";

import cosDbQueries from "../../data/cosdb-queries.json" with {
  type: "json",
};
import darwinOsQueries from "../../data/queries-darwin.json" with {
  type: "json",
};
import winOsQueries from "../../data/queries-win.json" with { type: "json" };
import defaultOsQueries from "../../data/queries.json" with { type: "json" };
